...
class CategoryService(Service):
    ...
    def execute(self, category_id: int, action: str = "get") -> Dict[str, Any]:
        ...
        if action == "get":
            ...
            return {"categories": [{"id": 1, "name": "Electronics"}, {"id": 2, "name": "Books"}]}
        else:
...
class ServiceFactory:
    ...
    def create_service(cls, service_type: str) -> Service:
        ...
        if service_type.lower() not in cls._services:
            ...
            error_msg = f"Unknown service type: {service_type}. Available: {available_services}"
...
class EmailNotificationService(NotificationService):
    ...
    def send_notification(self, recipient: str, message: str, subject: str = "Notification", **kwargs) -> bool:
...
class SMSNotificationService(NotificationService):
    ...
    def send_notification(self, recipient: str, message: str, priority: str = "normal", **kwargs) -> bool:
...
class PushNotificationService(NotificationService):
    ...
    def send_notification(self, recipient: str, message: str, device_type: str = "mobile", **kwargs) -> bool:
...
class NotificationManager:
    ...
    def send_notification(self, method: str, recipient: str, message: str, **kwargs) -> bool:
        """
        ...
        self.logger.info(f"🚀 Using {service.get_notification_method()} notification service")
...
def demonstrate_patterns():
    ...
    test_notifications = [
        ("email", "user@example.com", "Welcome to our service!", {"subject": "Welcome"}),
        ("sms", "1234567890", "Your order has been shipped!", {"priority": "high"}),
        ("push", "device_token_1234567890abcdef", "New update available!", {"device_type": "mobile"})
    ]
    
    for method, recipient, message, kwargs in test_notifications:
        success = notification_manager.send_notification(method, recipient, message, **kwargs)
