...
class DatabaseError(BaseAPIException):
    ...
    def __init__(
        self, message: str = "Database operation failed", details: Dict[str, Any] = None
    ):
...
class ConfigurationError(BaseAPIException):
    ...
    def __init__(
        self, message: str = "Configuration error", details: Dict[str, Any] = None
    ):
...
class ExceptionHandler:
    ...
    def handle_exception(self, exception: Exception) -> tuple:
        ...
        elif hasattr(exception, "__module__") and "sqlalchemy" in str(
...
def create_error_response(
    ...
    Returns:
        Tuple of (response_dict, status_code)
    """
    response = {"error": message, "error_code": error_code, "status_code": status_code}
