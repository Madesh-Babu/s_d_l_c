...
class TestCategoryRoutes:
    ...
    def test_create_category_insufficient_permissions(self, client, staff_headers, sample_category_data):
    ...
    def test_create_category_duplicate_name(self, client, admin_headers, create_test_category, sample_category_data):
    ...
    def test_get_all_categories_success(self, client, admin_headers, create_test_category):
    ...
    def test_get_category_by_id_success(self, client, admin_headers, create_test_category):
        """Test getting specific category by ID succeeds."""
        response = client.get(f'/categories/{create_test_category.id}', headers=admin_headers)
    ...
    def test_update_category_success(self, client, admin_headers, create_test_category):
        ...
        response = client.put(f'/categories/{create_test_category.id}',
    ...
    def test_delete_category_success(self, client, admin_headers, create_test_category):
        ...
        response = client.delete(f'/categories/{create_test_category.id}', headers=admin_headers)
    ...
    def test_delete_category_with_products(self, client, admin_headers, create_test_category, create_test_product):
    ...
    def test_get_category_products_success(self, client, admin_headers, create_test_category, create_test_product):
        """Test getting products in a category succeeds."""
        response = client.get(f'/categories/{create_test_category.id}/products', headers=admin_headers)
        
        assert response.status_code == 200
        data = json.loads(response.data)
        assert isinstance(data, list)
        assert len(data) >= 1
        assert all(product['category_id'] == create_test_category.id for product in data)

    def test_get_category_products_empty(self, client, admin_headers, create_test_category):
...
class TestCategoryBypass:
    ...
    def test_category_bypass_enabled_in_development(self, client, monkeypatch, sample_category_data):
    ...
    def test_category_bypass_disabled_in_production(self, client, monkeypatch, sample_category_data):
...
class TestCategoryServiceIntegration:
    ...
    def test_category_product_relationships(self, app, create_test_category, sample_product_data):
        ...
        with app.app_context():
            ...
            category_with_products = category_service.get_category_with_products(create_test_category.id)
