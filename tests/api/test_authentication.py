...
class TestAuthRoutes:
    ...
    def test_register_user_duplicate_email(self, client, create_test_user, sample_user_data):
    ...
    def test_update_user_success(self, client, admin_headers, create_test_user):
        ...
        response = client.put(f'/auth/{create_test_user.id}',
    ...
    def test_change_password_wrong_current(self, client, staff_headers, create_test_user):
