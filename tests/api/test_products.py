...
class TestProductRoutes:
    ...
    def test_create_product_success(
        self, client, admin_headers, create_test_category, sample_product_data
    ):
    ...
    def test_create_product_insufficient_permissions(
        self, client, staff_headers, sample_product_data
    ):
    ...
    def test_create_product_invalid_data(self, client, admin_headers):
        ...
        invalid_data = {"name": "", "price": -10}  # Empty name  # Negative price
    ...
    def test_get_product_by_id_success(
        self, client, admin_headers, create_test_product
    ):
        """Test getting specific product by ID succeeds."""
        response = client.get(
            f"/products/{create_test_product.id}", headers=admin_headers
        )
    ...
    def test_apply_discount_success(self, client, admin_headers, create_test_product):
        ...
        response = client.post(
            f"/products/{create_test_product.id}/discount",
    ...
    def test_apply_discount_invalid_percentage(
        ...
        discount_data = {"discount_percentage": 150}  # Invalid percentage
    ...
    def test_get_product_with_discount(
        self, client, admin_headers, create_test_product
    ):
    ...
    def test_product_category_validation(
        self, client, admin_headers, sample_product_data
    ):
...
class TestProductBypass:
    ...
    def test_product_bypass_enabled_in_development(
        self, client, monkeypatch, sample_product_data, create_test_category
    ):
    ...
    def test_product_bypass_disabled_in_production(
        self, client, monkeypatch, sample_product_data
    ):
