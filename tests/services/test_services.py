    ...
    def test_update_product_success(self, app, create_test_product):
        ...
        with app.app_context():
            ...
            updated_product = service.update_product(
                create_test_product.id, update_data
            )
...
class TestCategoryService:
    ...
    def test_create_category_duplicate_name(
        self, app, create_test_category, sample_category_data
    ):
    ...
    def test_update_category_success(self, app, create_test_category):
        ...
        with app.app_context():
            ...
            updated_category = service.update_category(
                create_test_category.id, update_data
            )
    ...
    def test_get_category_with_products(
        self, app, create_test_category, create_test_product
    ):
        ...
        with app.app_context():
            ...
            category_with_products = service.get_category_with_products(
...
class TestDiscountedProductService:
    ...
    def test_create_discounted_product(
        self, app, create_test_category, sample_product_data
    ):
