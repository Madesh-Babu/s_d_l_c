...
from src.core.logging import get_logger, setup_logging, LoggingMiddleware, log_user_action, log_api_error
...
class TestUtilityFunctions:
    ...
    def test_log_api_error(self):
        ...
        with patch('src.core.logging.get_logger') as mock_get_logger:
            ...
            log_api_error('validation_failed', endpoint='/auth/login', 
                         error='Invalid email', user_id=123)
    ...
    def test_log_api_error_without_user(self):
        ...
        with patch('src.core.logging.get_logger') as mock_get_logger:
            ...
            log_api_error('server_error', endpoint='/api/test', 
