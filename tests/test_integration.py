...
class TestApplicationIntegration:
    ...
    def test_full_product_workflow(self, client, admin_headers, sample_category_data, sample_product_data):
    ...
    def test_authentication_bypass_integration(self, client, monkeypatch, sample_user_data):
    ...
    def test_service_layer_integration(self, app, create_test_category, sample_product_data):
